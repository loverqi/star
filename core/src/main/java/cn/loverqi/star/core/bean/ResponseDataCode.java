...
public class ResponseDataCode {
    ...
    public static int CUSTOMER_NOT_NULL_ERROR = 4001;
    public static String CUSTOMER_NOT_NULL_MESSAGE = "该员工还有关联客户存在，请先处理";
   
    public static int Bill_NOT_NULL_ERROR = 4002;
    public static String Bill_NOT_NULL_MESSAGE = "该员工还有关联账单存在，请先处理";
